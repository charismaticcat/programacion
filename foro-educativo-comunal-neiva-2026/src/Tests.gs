...
function testFlujoCompletoGrupoPrueba() {
  ...
  var guardado = guardarSesion1("GRUPO-PRUEBA", tokenSesion, dispositivoId, {
    ...
    CONECTAEDUCA_P1: TEXTO_PRUEBA_50_PALABRAS_,
    CONECTAEDUCA_P2: TEXTO_PRUEBA_50_PALABRAS_,
    CONECTAEDUCA_P3: TEXTO_PRUEBA_50_PALABRAS_,
    CONECTAEDUCA_P4: TEXTO_PRUEBA_50_PALABRAS_,
    CONECTAEDUCA_P5: TEXTO_PRUEBA_50_PALABRAS_,
    CONECTAEDUCA_P6: TEXTO_PRUEBA_50_PALABRAS_
  });
